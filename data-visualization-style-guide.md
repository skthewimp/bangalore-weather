...
## Tufte Principles To Keep

1. Maximize data-ink ratio.
2. Remove non-data ink.
3. Avoid boxes, decoration, and default gridlines.
4. Do not repeat information.
5. Prefer small multiples over crowded panels.
6. Integrate labels into the chart.
7. Keep visual proportion faithful to data proportion.
